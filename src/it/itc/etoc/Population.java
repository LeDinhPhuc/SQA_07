...
class Population {
  ...
  /**
   * ChromosomeFormer is responsible for the creation of each single
   * individual and its evolution/recombination.
   */
  ...
  /**
   * Main parameter of the genetic algorithm:
   * number of individuals (chromosomes) in population.
   */
   ...
   *
   * @param signFile File with method signatures. Last method determines
   * the final call in chromosome.
   */
   ...
   * 
   * Individuals with higher fitness are more likely to be
   * chosen. Individuals are assumed to be sorted by decreasing fitness.
   */
  ...
  /**
   * Determines overall fitness and sorts individuals by decreasing
   * fitness.
   * 
   ...
   *
   * @param   target   branch to be covered
   * @return  true if an individual covering the given branch exists;
