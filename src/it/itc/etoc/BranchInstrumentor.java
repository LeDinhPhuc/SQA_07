...
public class BranchInstrumentor extends openjava.mop.OJClass
{
   ...
   */
    public void insertTraceField()
    {
        try {
            ...
            openjava.ptree.FieldDeclaration fd = new openjava.ptree.FieldDeclaration( new openjava.ptree.ModifierList( ModifierList.STATIC ), TypeName.forOJClass( OJClass.forName( traceInterfaceType ) ), "trace", new openjava.ptree.AllocationExpression( OJClass.forName( traceConcreteType ), new openjava.ptree.ExpressionList() ) );
   ...
   */
    public void insertTraceAccessor()
    {
        try {
            ...
            openjava.mop.OJMethod m = new openjava.mop.OJMethod( this, mod, OJClass.forName( traceInterfaceType ), "getTrace", new openjava.mop.OJClass[0], new openjava.mop.OJClass[0], body );
            addMethod( m );
        } catch ( openjava.mop.OJClassNotFoundException e ) {
            System.err.println( e );
            System.exit( 1 );
   ...
   */
    public void insertTraceCreator()
    {
        try {
            ...
            openjava.mop.OJModifier mod = OJModifier.forModifier( OJModifier.PUBLIC );
            mod = mod.add( OJModifier.STATIC );
            openjava.mop.OJMethod m = new openjava.mop.OJMethod( this, mod, OJClass.forName( "void" ), "newTrace", new openjava.mop.OJClass[0], new openjava.mop.OJClass[0], body );
            addMethod( m );
        } catch ( openjava.mop.OJClassNotFoundException e ) {
            System.err.println( e );
            System.exit( 1 );
   ...
   */
    ...
    public BranchInstrumentor( openjava.mop.Environment oj_param0, openjava.mop.OJClass oj_param1, openjava.ptree.ClassDeclaration oj_param2 )
    {
